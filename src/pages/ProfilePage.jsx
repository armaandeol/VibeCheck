  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex flex-col items-center justify-start relative overflow-hidden pt-16">
      <div className="relative z-10 w-full max-w-5xl mx-auto p-6">
        {/* Show Connect to Spotify button if not connected */}
        {!isSpotifyConnected && (
          <div className="flex justify-center mb-6">
            <button
              onClick={() => {
                // Use the same handler as SpotifySection
                const SpotifyService = require('../lib/spotify').default || require('../lib/spotify');
                window.location.href = SpotifyService.getAuthUrl();
              }}
              className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-300 flex items-center gap-2 shadow-lg"
            >
